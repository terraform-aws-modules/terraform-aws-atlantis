...
| <a name="input_enable_ephemeral_storage"></a> [enable\_ephemeral\_storage](#input\_enable\_ephemeral\_storage) | By default this example uses EFS storage, switch to true to use ephemeral storage | `bool` | `false` | no |

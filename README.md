...
| <a name="input_efs_additional_security_group_ids"></a> [efs\_additional\_security\_group\_ids](#input\_efs\_additional\_security\_group\_ids) | List of additional security groups to allow access to the EFS filesystem | `list(string)` | `[]` | no |

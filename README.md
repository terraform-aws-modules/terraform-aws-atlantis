...
| <a name="input_allow_unauthenticated_access_path_pattern"></a> [allow\_unauthenticated\_access\_path\_pattern](#input\_allow\_unauthenticated\_access\_path\_pattern) | The pattern to allow unauthenticated access (eg. allow GitHub webhooks for /events) | `string` | `""` | no |

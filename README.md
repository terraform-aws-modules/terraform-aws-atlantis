...
| <a name="input_atlantis_github_org"></a> [atlantis\_github\_org](#input\_atlantis\_github\_org) | GitHub organization that the Atlantis app is installed under | `string` | `""` | no |

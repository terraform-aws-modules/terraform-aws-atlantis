...
| <a name="input_log_configuration"></a> [log\_configuration](#input\_log\_configuration) | The logConfiguration for the container. This allows overridding the default `awslogs` settings. For more details, see https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_LogConfiguration.html | <pre>object({<br>    logDriver = string<br>    options   = map(string)<br>    secretOptions = list(<br>      object({<br>        name      = string<br>        valueFrom = string<br>      })<br>    )<br>  })</pre> | `null` | no |
